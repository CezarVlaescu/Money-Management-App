...
export const routes: Routes = [
  ...
  },
  {
    ...
    canMatch: [authPageGuard],
    loadComponent: () =>
      import('./pages/auth/register/register').then((component) => component.Register),
  },
  {
  ...
  },
  {
    path: 'privacy',
    loadComponent: () =>
      import('./features/privacy/privacy').then((component) => component.Privacy),
  },
  {
    path: 'auth/update-password',
    loadComponent: () =>
      import('./pages/auth/update-password/update-password').then(
        (component) => component.UpdatePassword,
      ),
  },
  {
    path: '',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'expenses',
        loadComponent: () =>
          import('./pages/expenses/expenses').then((component) => component.Expenses),
      },
      {
        path: 'savings-goals',
        loadComponent: () =>
          import('./pages/saving-goals/saving-goals').then((component) => component.SavingGoals),
      },
      {
        path: 'settings',
        loadComponent: () =>
      ...
      },
      {
        path: 'calendar',
        loadComponent: () =>
          import('./features/calendar/calendar').then((component) => component.Calendar),
      },
      {
        path: 'privacy',
        loadComponent: () =>
